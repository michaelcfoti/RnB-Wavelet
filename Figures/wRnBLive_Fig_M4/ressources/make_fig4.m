...
pause(0.1)
fprintf('  -- This plot shows the wavelet power (in log scale) for\n')
fprintf('     each scale, from the coarse (low frequency) to the fine\n')
fprintf('     scale (high frequency). \n')
fprintf('     The grey lines correspond to the 300 epochs. The black line is\n')
fprintf('     the average from which a slope can be determined.\n\n')
end